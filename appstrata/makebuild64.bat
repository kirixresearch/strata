...
set BUILD_DRIVE=d:
set BUILD_BASE=d:\build64
set SOURCE_PATH=d:\build64\src\trunk
...
set BUILDSRC=d:\build64\buildsrc
set BUILDSRCXR=d:\build64\buildsrc\xr
...
set S3BUCKET=builds.kirix.com/kirix-strata/development/64-bit
