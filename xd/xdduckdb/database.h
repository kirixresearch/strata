...
#ifndef H_XDDUCKDB_DATABASE_H
#define H_XDDUCKDB_DATABASE_H
...
class DuckdbDatabase : public xd::IDatabase
{
    friend class DuckdbRowInserter;
    friend class DuckdbIterator;
    friend class DuckdbStream;

    XCM_CLASS_NAME("xdsqlite.Database")
    XCM_BEGIN_INTERFACE_MAP(DuckdbDatabase)
...
public:
    ...
    duckdb::Connection* getPoolConnection();
    void freePoolConnection(duckdb::Connection* db);
...
private:
    ...
    DuckdbConnectionPool* m_connection_pool;
