...
#ifndef H_XDFS_FIXEDLENGTHTEXTITERATOR_H
#define H_XDFS_FIXEDLENGTHTEXTITERATOR_H
...
protected:
    ...
    static void func_field(kscript::ExprEnv* env, void* param, kscript::Value* retval);
