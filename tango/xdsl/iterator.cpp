...
tango::ISetPtr SlIterator::getChildSet(const std::wstring& relation_tag)
{
    return xcm::null;
}
...
const std::string& SlIterator::getString(tango::objhandle_t data_handle)
{
    ...
    {
        dai->result_str = (char*)sqlite3_column_text(m_stmt, dai->col_ordinal);
    }
...
const std::wstring& SlIterator::getWideString(tango::objhandle_t data_handle)
{
    ...
    {
        dai->result_wstr = kl::towstring((char*)sqlite3_column_text(m_stmt, dai->col_ordinal));
    }
