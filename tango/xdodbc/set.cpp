...
tango::IIndexInfoEnumPtr OdbcSet::getIndexEnum()
{
...
tango::IIndexInfoPtr OdbcSet::createIndex(const std::wstring& tag,
...
tango::IIndexInfoPtr OdbcSet::lookupIndex(const std::wstring& expr,
                                     bool exact_column_order)
{
    return xcm::null;
}

bool OdbcSet::deleteIndex(const std::wstring& name)
{
    return false;
}


bool OdbcSet::renameIndex(const std::wstring& name,
