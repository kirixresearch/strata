...
class MySqlSet : public CommonBaseSet
{

friend class MySqlDatabase;
friend class MySqlIterator;
friend class MySqlRowInserter;

    XCM_CLASS_NAME("xdmysql.Set")
    XCM_BEGIN_INTERFACE_MAP(MySqlSet)
