...
#ifndef __XDHTTP_SET_H
#define __XDHTTP_SET_H
...
class HttpSet : public CommonBaseSet
{

friend class HttpDatabase;
friend class HttpIterator;
friend class HttpRowInserter;

    XCM_CLASS_NAME("xdhttp.Set")
    XCM_BEGIN_INTERFACE_MAP(HttpSet)
...
{
    XCM_CLASS_NAME("xdhttp.RowInserter")
