...
#ifndef __XDHTTP_DATABASE_H
#define __XDHTTP_DATABASE_H
...
xcm_interface IHttpDatabase : public xcm::IObject
{
    XCM_INTERFACE_NAME("xdmysql.IHttpDatabase")
...
XCM_DECLARE_SMARTPTR(IHttpDatabase)


// database class definition
class HttpDatabase : public tango::IDatabase,
                     public IHttpDatabase
{
    XCM_CLASS_NAME("xdhttp.Database")
    XCM_BEGIN_INTERFACE_MAP(HttpDatabase)
        XCM_INTERFACE_ENTRY(tango::IDatabase)
        XCM_INTERFACE_ENTRY(IHttpDatabase)
