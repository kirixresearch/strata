...
#ifndef __XDHTTP_ITERATOR_H
#define __XDHTTP_ITERATOR_H
...
class HttpIterator : public CommonBaseIterator,
                     public tango::ICacheRowUpdate
{
friend class HttpDatabase;
friend class HttpSet;

    XCM_CLASS_NAME("xdhttp.Iterator")
    XCM_BEGIN_INTERFACE_MAP(HttpIterator)
...
private:
    ...
    std::map<int,HttpCacheRow*> m_cache_rows;
