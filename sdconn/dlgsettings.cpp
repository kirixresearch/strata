...
BEGIN_EVENT_TABLE(DlgSettings, wxDialog)
    EVT_BUTTON(wxID_OK, DlgSettings::onOK)
    EVT_BUTTON(wxID_CANCEL, DlgSettings::onCancel)
END_EVENT_TABLE()


DlgSettings::DlgSettings(wxWindow* parent) : wxDialog(parent,
                                                      -1,
                                                      _("Settings"),
                                                      wxDefaultPosition,
                                                      wxSize(400, 230),
...
void DlgSettings::setMessage(const wxString& message)
{
    m_message = message;
...
void DlgSettings::setUserName(const wxString& username)
{
    m_username = username;
...
void DlgSettings::onOK(wxCommandEvent& evt)
{
...
void DlgSettings::onCancel(wxCommandEvent& evt)
{
    m_username = "";
    m_password = "";
    m_service = "";
