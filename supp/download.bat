...
rem if not exist "%SCRIPT_DIR%\zip\postgres-16.6.zip" (
rem     curl -L -o "%SCRIPT_DIR%\zip\postgres-16.6.zip" https://github.com/postgres/postgres/archive/refs/tags/REL_16_6.zip
rem )
