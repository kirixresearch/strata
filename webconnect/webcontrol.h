...
#ifndef H_WXWEBCONNECT_WEBCONTROL_H
#define H_WXWEBCONNECT_WEBCONTROL_H
...
BEGIN_DECLARE_EVENT_TYPES()
    ...
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_AUI, wxEVT_WEB_CLICK, 0)
...
#define EVT_WEB_CLICK(winid, func) \
   wx__DECLARE_EVT1(wxEVT_WEB_CLICK, winid, wxWebEventHandler(func))
