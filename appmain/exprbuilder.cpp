...
static void populateFuncInfoList()
{
    ...
    func_info_list.push_back(FuncInfo(wxT("avg"),       _("AVG(input)"),                                     _("An aggregate function returning the average value from its input values")));
    ...
    func_info_list.push_back(FuncInfo(wxT("greatest"),  _("GREATEST(value1 [, value2, ...])"),               _("Returns the largest value from the input parameters")));
    ...
    func_info_list.push_back(FuncInfo(wxT("least"),     _("LEAST(value1 [, value2, ...])"),                  _("Returns the smallest value from the input parameters")));
    ...
    func_info_list.push_back(FuncInfo(wxT("max"),       _("MAX(input)"),                                     _("An aggregate function returning the maximum value from its input values")));
    func_info_list.push_back(FuncInfo(wxT("min"),       _("MIN(input)"),                                     _("An aggregate function returning the minimum value from its input values")));
    ...
    func_info_list.push_back(FuncInfo(wxT("stddev"),    _("STDDEV(input)"),                                  _("An aggregate function returning the standard deviation from its input values")));
    ...
    func_info_list.push_back(FuncInfo(wxT("sum"),       _("SUM(input)"),                                     _("An aggregate function returning the sum of its input values")));
    ...
    func_info_list.push_back(FuncInfo(wxT("variance"),  _("VARIANCE(input)"),                                _("An aggregate function returning the variance of its input values")));    
