...
#define APP_PALADIN_TEMP_LICENSE_COUNTER  "TMP17"
#endif


#define APPLICATION_NAME                wxT("Kirix Strata")
#define APP_COMPANY_NAME                wxT("Kirix Research, LLC")
...
#define APP_WEBLOCATION_ACCOUNT         wxT("www.kirix.com/account")
#define APP_WEBLOCATION_DEVELOPER       wxT("http://www.kirix.com/extensions/developer-resources.html")
#define APP_WEBLOCATION_SUPPORT         wxT("http://www.kirix.com/forums")
#define APP_WEBLOCATION_FUNCTIONHELP    wxT("http://www.kirix.com/help/docs/index.html?%s.htm")
#define APP_WEBLOCATION_CONTACT         wxT("http://www.kirix.com/contact-us.html")
#define APP_WEBLOCATION_WELCOME1        wxT("http://www.kirix.com/strata/welcome.html")
#define APP_WEBLOCATION_WELCOME2        wxT("http://www.kirix.com/strata/request-help.html")
#define APP_WEBLOCATION_LICENSEEXPIRING wxT("http://www.kirix.com/strata/expiration")
