...
static WebDOMNode* createAppropriateDOMNode(kscript::ExprEnv* env, wxDOMNode& node)
{
    ...
    if (name == wxT("PARAM"))
        return (WebDOMHTMLParamElement::createObject(env));
    if (name == wxT("SELECT"))
...
// (CLASS) WebDOMHTMLParamElement
// Category: DOM
// Derives: WebDOMHTMLElement
// Description: A class that represents an HTML param element.
// Remarks: The WebDOMHTMLParamElement class represents an HTML param element.

WebDOMHTMLParamElement::WebDOMHTMLParamElement()
{
}
...
// (CONSTRUCTOR) WebDOMHTMLParamElement.constructor
//
// Description: Creates a new WebDOMHTMLParamElement object.
//
// Syntax: WebDOMHTMLParamElement()
//
// Remarks: Creates a new WebDOMHTMLParamElement object.

void WebDOMHTMLParamElement::constructor(kscript::ExprEnv* env, kscript::Value* retval)
{
}

// (METHOD) WebDOMHTMLParamElement.getName
// Description:
//
// Syntax: WebDOMHTMLParamElement.getName() : String
//
// Remarks:
//
// Returns:

void WebDOMHTMLParamElement::getName(kscript::ExprEnv* env, kscript::Value* retval)
{
    // TODO: fill out documentation
    // wxString GetName();
    ...
    wxDOMHTMLParamElement e = m_node;
    if (!e.IsOk())
        return;
...
// (METHOD) WebDOMHTMLParamElement.setName
// Description:
//
// Syntax: WebDOMHTMLParamElement.setName(value : String)
//
// Remarks:
// Param(value): 

void WebDOMHTMLParamElement::setName(kscript::ExprEnv* env, kscript::Value* retval)
{
    // TODO: fill out documentation
...
// (METHOD) WebDOMHTMLParamElement.getType
// Description:
//
// Syntax: WebDOMHTMLParamElement.getType() : String
//
// Remarks:
//
// Returns:

void WebDOMHTMLParamElement::getType(kscript::ExprEnv* env, kscript::Value* retval)
{
    // TODO: fill out documentation
    // wxString GetType();
...
// (METHOD) WebDOMHTMLParamElement.setType
// Description:
//
// Syntax: WebDOMHTMLParamElement.setType(value : String)
//
// Remarks:
// Param(value): 

void WebDOMHTMLParamElement::setType(kscript::ExprEnv* env, kscript::Value* retval)
{
    // TODO: fill out documentation
...
// (METHOD) WebDOMHTMLParamElement.getValueType
// Description:
//
// Syntax: WebDOMHTMLParamElement.getValueType() : String
//
// Remarks:
//
// Returns:

void WebDOMHTMLParamElement::getValueType(kscript::ExprEnv* env, kscript::Value* retval)
{
    // TODO: fill out documentation
    ...
    retval->setString(e.GetValueType().wc_str());
}

// (METHOD) WebDOMHTMLParamElement.setValueType
// Description:
//
// Syntax: WebDOMHTMLParamElement.setValueType(value : String)
//
// Remarks:
// Param(value):

void WebDOMHTMLParamElement::setValueType(kscript::ExprEnv* env, kscript::Value* retval)
{
    // TODO: fill out documentation
    ...
    e.SetValueType(env->getParam(0)->getString());
}
...
// (METHOD) WebDOMHTMLSelectElement.getTabIndex
// Description:
//
// Syntax: WebDOMHTMLSelectElement.getTabIndex() : Integer
//
// Remarks:
//
// Returns:

void WebDOMHTMLSelectElement::getTabIndex(kscript::ExprEnv* env, kscript::Value* retval)
{
    // TODO: fill out documentation
    // int GetTabIndex();
...
// (METHOD) WebDOMHTMLSelectElement.setTabIndex
// Description:
//
// Syntax: WebDOMHTMLSelectElement.setTabIndex(value : Integer)
//
// Remarks:
// Param(value):

void WebDOMHTMLSelectElement::setTabIndex(kscript::ExprEnv* env, kscript::Value* retval)
{
    // TODO: fill out documentation
    // void SetTabIndex(int index);
...
// (METHOD) WebDOMHTMLTextAreaElement.getTabIndex
// Description:
//
// Syntax: WebDOMHTMLTextAreaElement.getTabIndex() : Integer
//
// Remarks:
//
// Returns:

void WebDOMHTMLTextAreaElement::getTabIndex(kscript::ExprEnv* env, kscript::Value* retval)
{
    // TODO: fill out documentation
    // int GetTabIndex();
...
// (METHOD) WebDOMHTMLTextAreaElement.setTabIndex
// Description:
//
// Syntax: WebDOMHTMLTextAreaElement.setTabIndex(value : Integer)
//
// Remarks:
// Param(value):

void WebDOMHTMLTextAreaElement::setTabIndex(kscript::ExprEnv* env, kscript::Value* retval)
{
    // TODO: fill out documentation
    // void SetTabIndex(int value);
